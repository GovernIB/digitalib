...
public class ConfiguracioFirmaJPAManager
		 extends AbstractDigitalIBJPAManager<ConfiguracioFirma, Long>
		 implements IConfiguracioFirmaManager, ConfiguracioFirmaFields {




  private static final long serialVersionUID = 1413284814L;

	 public static final TableName<ConfiguracioFirma> _TABLENAME =  new TableName<ConfiguracioFirma>("ConfiguracioFirmaJPA");



  static final ModificationManager<ConfiguracioFirma> __eventManager = new ModificationManager<ConfiguracioFirma>();
  ...
  protected EntityManager getEntityManager() {
	...
	public ModificationManager<ConfiguracioFirma> getEventManager() {
	...
	public synchronized ConfiguracioFirma create( int _usPoliticaDeFirma_, java.lang.String _policyIdentifier_, java.lang.String _policyIdentifierHash_, java.lang.String _policyIdentifierHashAlgorithm_, java.lang.String _policyUrlDocument_, int _tipusOperacioFirma_, int _tipusFirmaID_, java.lang.Integer _algorismeDeFirmaID_, boolean _modeDeFirma_, int _politicaTaulaFirmes_, int _posicioTaulaFirmesID_, java.lang.Long _firmatPerFormatID_, java.lang.Long _motiuDelegacioID_, java.lang.String _propietatsTaulaFirmes_, long _pluginFirmaServidorID_, boolean _incloureSegellDeTemps_, java.lang.Long _pluginSegellatID_) throws I18NException {
		ConfiguracioFirmaJPA __bean =  new ConfiguracioFirmaJPA(_usPoliticaDeFirma_,_policyIdentifier_,_policyIdentifierHash_,_policyIdentifierHashAlgorithm_,_policyUrlDocument_,_tipusOperacioFirma_,_tipusFirmaID_,_algorismeDeFirmaID_,_modeDeFirma_,_politicaTaulaFirmes_,_posicioTaulaFirmesID_,_firmatPerFormatID_,_motiuDelegacioID_,_propietatsTaulaFirmes_,_pluginFirmaServidorID_,_incloureSegellDeTemps_,_pluginSegellatID_);
