...
public class AuditoriaBeanValidator 
  ...
  // EJB's
  protected final es.caib.digitalib.model.dao.IAuditoriaManager __auditoriaManager;


  public final AuditoriaValidator<AuditoriaJPA> _validator;


  public AuditoriaBeanValidator(es.caib.digitalib.model.dao.IAuditoriaManager __auditoriaManager) { 
