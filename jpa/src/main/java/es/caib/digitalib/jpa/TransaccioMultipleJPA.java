...
private static final long serialVersionUID = 677845580L;

	@Id
	@Index(name="dib_transmultiple_pk_i")
	...
	@Index(name="dib_transmul_fscaned_fk_i")
...
// IMP Field:fitxerid | Table: dib_fitxer | Type: 1  
	...
	@ForeignKey(name="dib_transmul_fitxer_fies_fk")
