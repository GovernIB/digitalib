...
private static final long serialVersionUID = 1036906268L;
	...
	@Index(name="dib_avis_pk_i")
	@Column(name="avisid",nullable = false,length = 19)
	long avisID;

	@Index(name="dib_avis_descripcioid_fk_i")
	...
	@Index(name="dib_avis_configgrupid_fk_i")
...
// IMP Field:traduccioid | Table: dib_traduccio | Type: 1  
	...
	@ForeignKey(name="dib_avis_traduccio_desc_fk")
...
// IMP Field:configuraciogrupid | Table: dib_configuraciogrup | Type: 1  
	...
	@ForeignKey(name="dib_avis_cfggrup_configgrup_fk")
	@JoinColumn(name = "configgrupid", referencedColumnName ="configuracioGrupID", nullable = true, insertable=false, updatable=false)
