 ...
 *
 */
public class DataExporterDigitalIB implements IDataExporter {
     ...
     */
    public DataExporterDigitalIB(IExportDataPlugin exportDataPlugin) {
        super();
    ...
    public DataExported exportList(BaseFilterForm filterForm,
            ...
            Map<Field<?>, Map<String, String>> mapValuesByField, Field<?>[] primaryKeys)
            throws Exception {
        ...
        ExportData exportData = getExportData(filterForm, list, visibleFields,
                mapValuesByField, primaryKeys);
    ...
    private ExportData getExportData(BaseFilterForm filterForm,
        ...
        TreeMap<Integer, AdditionalField<?, ?>> additionalFields = filterForm
                .getAdditionalFields();
        ...
        // Afegir valors
        int len = list.size();
        ExportItem[][] items = new ExportItem[len][visibleFields.length
        ...
        for (Integer pos : additionalFields.keySet()) {
            ...
            for (int j = 0; j < len; j++) {
                ...
                Object keyValue = Utils.getValueOfJavaField(list.get(j),
        ...
        for (Integer pos : additionalFields.keySet()) {
            ...
            for (int j = 0; j < len; j++) {
                ...
                if (values == null) {
                    ...
                    Object value = getRecursiveValueOfJavaField(list.get(j),
                            field);
    ...
    private  Object getRecursiveValueOfJavaField(Object target, String path) {
        ...
        if (pos == -1) {
            ...
            Object target2 = Utils.getValueOfJavaField(target,
                    field);
    ...
    public static Field<?>[] getVisibleFields(BaseFilterForm filterForm,
            Field<?>[] allFields) {
        Field<?>[] visibleFields;
        {
