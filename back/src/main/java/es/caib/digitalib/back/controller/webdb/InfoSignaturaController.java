...
import es.caib.digitalib.back.validator.webdb.InfoSignaturaWebValidator;
...
public class InfoSignaturaController
  ...
  public String editarInfoSignaturaPost(@ModelAttribute @Valid InfoSignaturaForm infoSignaturaForm,
    ...
    try {
      preValidate(request, infoSignaturaForm, result);
      getWebValidator().validate(infoSignatura, result);
      postValidate(request, infoSignaturaForm, result);
