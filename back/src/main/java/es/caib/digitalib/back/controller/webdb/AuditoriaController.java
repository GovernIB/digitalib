...
import es.caib.digitalib.back.validator.webdb.AuditoriaWebValidator;
...
public class AuditoriaController
  ...
  @EJB(mappedName = es.caib.digitalib.ejb.AuditoriaLocal.JNDI_NAME)
  ...
  public Map<Field<?>, GroupByItem> fillReferencesForList(AuditoriaFilterForm filterForm,
    ...
    // Field tipus
    {
      ...
      fillValuesToGroupByItemsBoolean("auditoria.tipustransaccio", groupByItemsMap, ISAPP);
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarAuditoriaPost(@ModelAttribute @Valid AuditoriaForm auditoriaForm,
    ...
    try {
      preValidate(request, auditoriaForm, result);
      getWebValidator().validate(auditoria, result);
      postValidate(request, auditoriaForm, result);
