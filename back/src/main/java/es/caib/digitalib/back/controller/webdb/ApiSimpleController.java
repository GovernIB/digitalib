...
public class ApiSimpleController
  ...
  public String editarApiSimplePost(@ModelAttribute @Valid ApiSimpleForm apiSimpleForm,
    ...
    try {
      preValidate(request, apiSimpleForm, result);
      getWebValidator().validate(apiSimple, result);
      postValidate(request, apiSimpleForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String getSessionAttributeFilterForm() {
    return "ApiSimpleWebDB_FilterForm";
  }
  ...
  public void delete(HttpServletRequest request, ApiSimple apiSimple) throws Exception,I18NException {
