...
public class ConfigurationJPA {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    em.setPackagesToScan(new String[] { "es.caib.digitalib.jpa" });
  ...
  public DataSource dataSource() {
    DataSource ds = (DataSource) getFromInitialContext("java:/es.caib.digitalib.db");
    return ds;
  }
  ...
  private Properties additionalProperties() {
    ...
    final String hibernateProp = Constants.DIGITALIB_PROPERTY_BASE + "hibernate.";
    final int cutIndex = Constants.DIGITALIB_PROPERTY_BASE.length();
