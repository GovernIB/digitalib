...
public class ConfiguracioGrupController
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarConfiguracioGrupPost(@ModelAttribute @Valid ConfiguracioGrupForm configuracioGrupForm,
    ...
    try {
      this.setFilesFormToEntity(afm, configuracioGrup, configuracioGrupForm); // FILE
      preValidate(request, configuracioGrupForm, result);
      getWebValidator().validate(configuracioGrup, result);
      postValidate(request, configuracioGrupForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String getSessionAttributeFilterForm() {
    return "ConfiguracioGrupWebDB_FilterForm";
  }
  ...
  public void delete(HttpServletRequest request, ConfiguracioGrup configuracioGrup) throws Exception,I18NException {
