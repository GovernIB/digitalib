  ...
  if (existsSecureContextStatic == null) {
    try {  
      ...
      if (propData == null) {
        ...
        String value = properties.getProperty("digitalib.clientcert");
...
if (existsSecureContext) {
  ...
  final boolean thisContextIsClientCert = "/digitalibs".equals(context);
  
  if (thisContextIsClientCert && "http".equals(scheme)) {
    // Hem de passar a digitalib
    context = "/digitalib";
  } else {
    // Hem de passar a digitalibs
