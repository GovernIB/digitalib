...
<div>
  <h5><fmt:message key="administrador.digitalib.menu" /></h5>
  <ul class="tree" style="margin: 3px; padding: 0px;">
   ...
   <sec:authorize access="hasAnyRole('ROLE_SOLI', 'ROLE_DEST', 'ROLE_COLA', 'ROLE_DELE')">
    ...
    <hr style="margin-top: 6px;  margin-bottom: 6px; border: none; height: 1px; background: gray" />
...
<div class="thumbnail" style="margin-top:30px;">
  <div>
  <h5><fmt:message key="administrador.copia.menu" /></h5>
  <ul class="tree" style="margin: 3px; padding: 0px;">
