  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariPersonaFields.USUARIPERSONAID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="usuariPersona.usuariPersonaID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariPersonaFields.USERNAME)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuariPersona.username" var="username" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariPersonaFields.ROLESCAN)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="usuariPersona.roleScan" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariPersonaFields.ROLECOAU)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="usuariPersona.roleCoAu" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariPersonaFields.ROLECUST)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="usuariPersona.roleCust" />:</span>
