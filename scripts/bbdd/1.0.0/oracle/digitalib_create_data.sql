...
es.caib.portafib.plugins.documentcustody.alfresco.automatic_metadata.4.valueEL=${registre.tipoDocumental}'), 1, 2, 'DOCCUST_ALFRESCO', 3, 'Document Custody d''Alfresco 5.x', 'Document Custody d''Alfresco 5.x');
