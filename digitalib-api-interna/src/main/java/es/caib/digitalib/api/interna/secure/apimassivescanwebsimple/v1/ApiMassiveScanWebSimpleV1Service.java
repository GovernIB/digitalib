...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de DigitalIB - ApiMassiveScanWebSimple",
                description = "Conjunt de Serveis REST de DigitalIB per la realització remota d'escanejos",
        ...
        externalDocs = @ExternalDocumentation(
                description = "Java Client ApiMassiveScanWebSimple (GovernIB Github)",
                url = "https://github.com/GovernIB/digitalib/tree/digitalib-2.0/digitalib-api-interna-client-apimassivescanwebsimple-v1")
            ...
            value = {
                    ...
                    @ApiResponse(
                            ...
                            content = { @Content(
                                    mediaType = MediaType.APPLICATION_JSON,
                                    schema = @Schema(implementation = RestExceptionInfo.class)) }) })
    public MassiveScanWebSimpleAvailableProfiles getAvailableProfiles(
            @RequestBody(
                    description = "Idioma. Valors permesos 'es' o 'ca'",
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON,
                            schema = @Schema(
                                    name = "language",
                                    required = true,
                                    implementation = String.class))) String language,
    ...
    public MassiveScanWebSimpleStatus getSubTransactionStatus(@RequestBody(
            ...
            content = @Content(
                    ...
                    schema = @Schema(
                            name = "subTransactionID",
                            required = true,
                            implementation = String.class))) String subTransactionID)
            throws Exception {
