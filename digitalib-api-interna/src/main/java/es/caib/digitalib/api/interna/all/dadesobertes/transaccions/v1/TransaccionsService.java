...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de DigitalIB - Dades Obertes - Transaccions",
                description = "Conjunt de Serveis REST de DigitalIB per la realització de consultes dad dades obertes de Transaccions",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/digitalib/tree/digitalib-2.0/digitalib-api-interna"))
public class TransaccionsService extends RestUtils {
    ...
    public static final String PATH = "/public/dadesobertes/transaccions/v1";
