...
(function() {
	...
	tinymce.create('tinymce.util.URI', {
		URI : function(u, s) {
			...
			// Strange app protocol that isn't http/https or Service anchor
		...
		function addValidElements(valid_elements) {
			...
			if (valid_elements) {
				...
				for (ei = 0, el = valid_elements.length; ei < el; ei++) {
					...
					if (matches) {
						// Setup Service names for matches
						prefix = matches[1];
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		convertURL : function(url, name, elm) {
			...
			// Don't convert link href since thats the CSS files that gets loaded into the editor also skip Service file URLs
