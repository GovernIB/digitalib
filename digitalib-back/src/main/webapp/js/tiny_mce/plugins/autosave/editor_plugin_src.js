...
(function(tinymce) {
	...
	tinymce.create('tinymce.plugins.AutoSave', {
		...
		init : function(ed, url) {
			...
			/**
			 * This event gets fired when a draft is stored to Service storage.
			 *
			 * @event onStoreDraft
			...
			/**
			 * This event gets fired when a draft is restored from Service storage.
			 *
			 * @event onStoreDraft
			 * @param {tinymce.plugins.AutoSave} sender Plugin instance sending the event.
			 * @param {Object} draft Draft object containing the HTML contents of the editor.
		...
		/**
		 * This method will return true/false if there is a Service storage draft available.
		 *
		 * @method hasDraft
		 * @return {boolean} true/false state if there is a Service draft.
		 */
		hasDraft : function() {
