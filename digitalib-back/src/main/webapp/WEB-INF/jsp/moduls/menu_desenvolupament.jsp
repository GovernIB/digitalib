  ...
  <ul class="tree" style="margin: 3px; padding: 0px;">
    ...
    <li>
      ...
      <ul class="branch in">
        ...
        <li style="list-style-type: disc; list-style-position: inside;">
          <a href="<c:url value="/desenvolupament/deletemethod"/>">
    ...
    <li>
      ...
      <li style="list-style-type: disc; list-style-position: inside;">
        <a href="<c:url value="/desenvolupament/hibernateerror"/>">
    ...
    <li>
      ...
      <ul class="branch in">
          <li style="list-style-type: disc; list-style-position: inside;">
            <a href="<c:url value="/desenvolupament/modelandviewnoexisteix"/>">
              <span>ModelAndView noexisteix</span>
            </a>
          </li>
          
          <li style="list-style-type: disc; list-style-position: inside;">
            <a href="<c:url value="/desenvolupament/errorcallback"/>">
              <span>Error Call Back</span>
            </a>
          </li>

          <li style="list-style-type: disc; list-style-position: inside;">
            <a href="<c:url value="/desenvolupament/errorinvaliduser"/>">
              <span>Invalid User</span>
            </a>
          </li>
          
          <li style="list-style-type: disc; list-style-position: inside;">
            <a href="<c:url value="/desenvolupament/servletexception"/>">
              <span>ServletException</span>
            </a>
          </li>
          
          <li style="list-style-type: disc; list-style-position: inside;">
            <a href="<c:url value="/desenvolupament/jspexception"/>">
