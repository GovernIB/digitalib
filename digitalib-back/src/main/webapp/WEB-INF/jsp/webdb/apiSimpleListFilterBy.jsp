...
<un:useConstants var="ApiSimpleFields" className="es.caib.digitalib.model.fields.ApiSimpleFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ApiSimpleFields.APISIMPLEID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="apiSimple.apiSimpleID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ApiSimpleFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="apiSimple.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ApiSimpleFields.URL)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="apiSimple.url" var="url" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ApiSimpleFields.USERNAME)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="apiSimple.username" var="username" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ApiSimpleFields.CONTRASENYA)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="apiSimple.contrasenya" var="contrasenya" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ApiSimpleFields.CONFIGDEFIRMA)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="apiSimple.configDeFirma" var="configDeFirma" />
              <fmt:message key="genapp.form.searchby" var="cercaperconfigDeFirma" >                
                 <fmt:param value="${configDeFirma}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${configDeFirma}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercaperconfigDeFirma}" path="configDeFirma" />
            </div>
