...
<un:useConstants var="PerfilUsuariAplicacioFields" className="es.caib.digitalib.model.fields.PerfilUsuariAplicacioFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilUsuariAplicacioFields.PERFILUSRAPPID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="perfilUsuariAplicacio.perfilUsrAppID" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="perfilUsrAppIDDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="perfilUsrAppIDFins" />

            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilUsuariAplicacioFields.PERFILID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="perfilUsuariAplicacio.perfilID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilUsuariAplicacioFields.USUARIAPLICACIOID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="perfilUsuariAplicacio.usuariAplicacioID" />:</span>
