      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilFields.SCANFORMATFITXER)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="perfil_scanFormatFitxer_select" path="scanFormatFitxerSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
                    <c:forEach var="_entry" items="${__theFilterForm.mapOfValuesForScanFormatFitxer}">
                      <option value="${_entry.key}" ${fn:contains(__theFilterForm.scanFormatFitxerSelect, _entry.key)?'selected':''} >${_entry.value}</option>
                    </c:forEach>
                </form:select>
              </div>
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#perfil_scanFormatFitxer_select').select2({
                        closeOnSelect: false
                    });
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilFields.SCANMINIMARESOLUCIO)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="perfil_scanMinimaResolucio_select" path="scanMinimaResolucioSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
                    <c:forEach var="_entry" items="${__theFilterForm.mapOfValuesForScanMinimaResolucio}">
                      <option value="${_entry.key}" ${fn:contains(__theFilterForm.scanMinimaResolucioSelect, _entry.key)?'selected':''} >${_entry.value}</option>
                    </c:forEach>
                </form:select>
              </div>
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#perfil_scanMinimaResolucio_select').select2({
                        closeOnSelect: false
                    });
                    $('.select2-selection__rendered').css('padding-bottom','5px');
                });
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilFields.SCANPIXELTYPE)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="perfil_scanPixelType_select" path="scanPixelTypeSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
                    <c:forEach var="_entry" items="${__theFilterForm.mapOfValuesForScanPixelType}">
                      <option value="${_entry.key}" ${fn:contains(__theFilterForm.scanPixelTypeSelect, _entry.key)?'selected':''} >${_entry.value}</option>
                    </c:forEach>
                </form:select>
              </div>
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#perfil_scanPixelType_select').select2({
                        closeOnSelect: false
                    });
                    $('.select2-selection__rendered').css('padding-bottom','5px');
                });
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilFields.TIPUSFIRMA)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="perfil_tipusFirma_select" path="tipusFirmaSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#perfil_tipusFirma_select').select2({
                        closeOnSelect: false
                    });
                    $('.select2-selection__rendered').css('padding-bottom','5px');
                });
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilFields.CONFIGURACIOFIRMAID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="perfil.configuracioFirmaID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilFields.TIPUSCUSTODIA)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="perfil_tipusCustodia_select" path="tipusCustodiaSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
                    <c:forEach var="_entry" items="${__theFilterForm.mapOfValuesForTipusCustodia}">
                      <option value="${_entry.key}" ${fn:contains(__theFilterForm.tipusCustodiaSelect, _entry.key)?'selected':''} >${_entry.value}</option>
                    </c:forEach>
                </form:select>
              </div>
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#perfil_tipusCustodia_select').select2({
                        closeOnSelect: false
                    });
                    $('.select2-selection__rendered').css('padding-bottom','5px');
                });
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PerfilFields.USPERFIL)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="perfil_usPerfil_select" path="usPerfilSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
                    <c:forEach var="_entry" items="${__theFilterForm.mapOfValuesForUsPerfil}">
                      <option value="${_entry.key}" ${fn:contains(__theFilterForm.usPerfilSelect, _entry.key)?'selected':''} >${_entry.value}</option>
                    </c:forEach>
                </form:select>
              </div>
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#perfil_usPerfil_select').select2({
                        closeOnSelect: false
                    });
                    $('.select2-selection__rendered').css('padding-bottom','5px');
                });
