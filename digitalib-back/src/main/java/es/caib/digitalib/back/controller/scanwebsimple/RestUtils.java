...
import es.caib.digitalib.ejb.UsuariAplicacioService;
...
public class RestUtils {
  ...
  protected String autenticate(HttpServletRequest request, String locale, UsuariAplicacioService usuariAplicacioEjb) {
    ...
    try {
      ...
      //if (Configuracio.isCAIB()) 
      {
        ...
        Subject s =  login(username, password, "keycloak");
        autenticat = (s != null);
      }
      /*
      else {
