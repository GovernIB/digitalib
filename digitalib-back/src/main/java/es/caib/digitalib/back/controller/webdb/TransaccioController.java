...
public class TransaccioController
  ...
  public String eliminarTransaccio(@PathVariable("transaccioID") java.lang.Long transaccioID,
    ...
    try {
      Transaccio transaccio = this.findByPrimaryKey(request, transaccioID);
      if (transaccio == null) {
 ...
 exceptionMsg };
  ...
  public List<StringKeyValue> getReferenceListForUsuariAplicacioId(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(USUARIAPLICACIOID)
       ...
       && !transaccioFilterForm.isFilterByField(USUARIAPLICACIOID)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForUsuariPersonaId(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(USUARIPERSONAID)
       ...
       && !transaccioFilterForm.isFilterByField(USUARIPERSONAID)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForEstatCodi(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(ESTATCODI)
       ...
       && !transaccioFilterForm.isFilterByField(ESTATCODI)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForInfoScanPixelType(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(INFOSCANPIXELTYPE)
       ...
       && !transaccioFilterForm.isFilterByField(INFOSCANPIXELTYPE)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForInfoScanLanguageDoc(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(INFOSCANLANGUAGEDOC)
       ...
       && !transaccioFilterForm.isFilterByField(INFOSCANLANGUAGEDOC)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForInfoScanDocumentTipus(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(INFOSCANDOCUMENTTIPUS)
       ...
       && !transaccioFilterForm.isFilterByField(INFOSCANDOCUMENTTIPUS)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForView(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(VIEW)
       ...
       && !transaccioFilterForm.isFilterByField(VIEW)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForArxiuReqParamDocEstatElabora(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(ARXIUREQPARAMDOCESTATELABORA)
       ...
       && !transaccioFilterForm.isFilterByField(ARXIUREQPARAMDOCESTATELABORA)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForArxiuReqParamOrigen(HttpServletRequest request,
    ...
    if (transaccioFilterForm.isHiddenField(ARXIUREQPARAMORIGEN)
       ...
       && !transaccioFilterForm.isFilterByField(ARXIUREQPARAMORIGEN)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
