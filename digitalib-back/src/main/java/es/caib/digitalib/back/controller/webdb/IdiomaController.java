...
import es.caib.digitalib.back.form.webdb.IdiomaForm;

import es.caib.digitalib.back.validator.webdb.IdiomaWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="idioma.idioma.plural", order=70, group=Tab.MENU_WEBDB)
@Controller
...
public class IdiomaController
    extends es.caib.digitalib.back.controller.DigitalIBBaseController<Idioma, java.lang.String> implements IdiomaFields {
