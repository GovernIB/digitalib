...
import es.caib.digitalib.back.validator.webdb.PluginWebValidator;
...
public class PluginController
    extends es.caib.digitalib.back.controller.DigitalIBBaseController<Plugin, java.lang.Long> implements PluginFields {

  @EJB(mappedName = es.caib.digitalib.ejb.PluginService.JNDI_NAME)
