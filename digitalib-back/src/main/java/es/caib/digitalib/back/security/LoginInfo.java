...
public class LoginInfo {
     ...
     * @param roles
     */
    public LoginInfo(User springSecurityUser, UsuariPersonaJPA usuariPersona, Set<GrantedAuthority> grantedAuthorities,
            boolean needConfigUser) {
     ...
     * @param roles
     */
    public LoginInfo(User springSecurityUser, UsuariAplicacioJPA usuariAplicacio, Set<GrantedAuthority> roles) {
        this.springSecurityUser = springSecurityUser;
