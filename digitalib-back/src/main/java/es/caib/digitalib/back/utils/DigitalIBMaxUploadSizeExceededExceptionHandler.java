 ...
 * 
 */
public class DigitalIBMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof DigitalIBMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof DigitalIBMaxUploadSizeExceededException) {
          msgCode = ((DigitalIBMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
