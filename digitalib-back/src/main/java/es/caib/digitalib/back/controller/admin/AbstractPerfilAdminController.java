...
public abstract class AbstractPerfilAdminController extends PerfilController {
    ...
    @Override
    public PerfilFilterForm getPerfilFilterForm(Integer pagina, ModelAndView mav, HttpServletRequest request)
        ...
        if (filterForm.isNou()) {
            ...
            Set<Field<?>> ocults = new HashSet<Field<?>>(Arrays.asList(PerfilFields.ALL_PERFIL_FIELDS));
            ...
            switch (tipusperfil) {
                ...
                case Constants.PERFIL_US_NOMES_ESCANEIG:
                    ...
                    filterForm.getGroupByFields().remove(PerfilFields.CONFIGURACIOFIRMAID);
                ...
                case Constants.PERFIL_US_CUSTODIA:
                    ...
                    // Ocultar tipus Custòdia si propietat isOcultarDocumentCustody() és true
    ...
    @Override
    public PerfilForm getPerfilForm(PerfilJPA _jpa, boolean __isView, HttpServletRequest request, ModelAndView mav)
            throws I18NException {
        ...
        if (perfilForm.isNou()) {
            ...
            switch (tipusPerfil) {
                ...
                case Constants.PERFIL_US_COPIA_AUTENTICA:
                    perfilForm.getPerfil().setTipusCustodia(Constants.TIPUS_CUSTODIA_SENSE);
                    perfilForm.getPerfil().setTipusFirma(Constants.TIPUS_FIRMA_EN_SERVIDOR_APISIMPLE);
                break;

                case Constants.PERFIL_US_CUSTODIA:
                    perfilForm.getPerfil().setTipusFirma(Constants.TIPUS_FIRMA_EN_SERVIDOR_APISIMPLE);
                    perfilForm.getPerfil().setTipusCustodia(Constants.TIPUS_CUSTODIA_ARXIU);
        ...
        // Ocultar tipusFirma i PLugin de Firma en servidor si propietat isOcultarFirmaEnServidor() és true
    ...
    @Override
    public List<StringKeyValue> getReferenceListForPluginScanWebID(HttpServletRequest request, ModelAndView mav,
    ...
    @Override
    public List<StringKeyValue> getReferenceListForPluginScanWeb2ID(HttpServletRequest request, ModelAndView mav,
            Where where) throws I18NException {
        Where w = Where.AND(where, PluginFields.TIPUS.equal(Constants.TIPUS_PLUGIN_SCANWEB));
    ...
    */
    ...
    @Override
    public List<StringKeyValue> getReferenceListForUsPerfil(HttpServletRequest request, ModelAndView mav, Where where)
            throws I18NException {
        List<StringKeyValue> __tmp = new java.util.ArrayList<StringKeyValue>();
        ...
        __tmp.add(new StringKeyValue(String.valueOf(Constants.PERFIL_US_NOMES_ESCANEIG_INFO), "Només escaneig - Info"));
        __tmp.add(
                new StringKeyValue(String.valueOf(Constants.PERFIL_US_COPIA_AUTENTICA_INFO), "Còpia autèntica - Info"));
        __tmp.add(new StringKeyValue(String.valueOf(Constants.PERFIL_US_CUSTODIA_INFO), "Custòdia - Info"));
        return __tmp;
    }

    @Override
    public List<StringKeyValue> getReferenceListForScanFormatFitxer(HttpServletRequest request, ModelAndView mav,
            Where where) throws I18NException {
        List<StringKeyValue> __tmp = new java.util.ArrayList<StringKeyValue>();
    ...
    @Override
    public List<StringKeyValue> getReferenceListForScanPixelType(HttpServletRequest request, ModelAndView mav,
            Where where) throws I18NException {
        List<StringKeyValue> __tmp = new java.util.ArrayList<StringKeyValue>();
        __tmp.add(new StringKeyValue(String.valueOf(Constants.PIXEL_TYPE_BLACK_WHITE),
                I18NUtils.tradueix("pixeltype.0")));
    ...
    @Override
    public List<StringKeyValue> getReferenceListForTipusCustodia(HttpServletRequest request, ModelAndView mav,
            Where where) throws I18NException {
        List<StringKeyValue> __tmp = new java.util.ArrayList<StringKeyValue>();

        int tipusPerfil = getTipusPerfil();

        if (tipusPerfil == Constants.PERFIL_US_ALL_INFO || tipusPerfil == Constants.PERFIL_US_CUSTODIA
                || tipusPerfil == Constants.PERFIL_US_CUSTODIA_INFO) {
            __tmp.add(new StringKeyValue(String.valueOf(Constants.TIPUS_CUSTODIA_ARXIU),
                    I18NUtils.tradueix("tipuscustodia.1")));
            ...
            __tmp.add(new StringKeyValue(String.valueOf(Constants.TIPUS_CUSTODIA_SENSE),
                    I18NUtils.tradueix("tipuscustodia.0")));
        }
        return __tmp;
    }

    @Override
    public List<StringKeyValue> getReferenceListForPluginArxiuID(HttpServletRequest request, ModelAndView mav,
            Where where) throws I18NException {
    ...
    @Override
    public List<StringKeyValue> getReferenceListForPluginDocCustodyID(HttpServletRequest request, ModelAndView mav,
            Where where) throws I18NException {
    ...
    public Where getAdditionalCondition(HttpServletRequest request) throws I18NException {
        ...
        if (tipusPerfil == Constants.PERFIL_US_ALL_INFO) {
            w = USPERFIL.in(new Integer[] { Constants.PERFIL_US_NOMES_ESCANEIG_INFO,
        ...
        switch (perfil.getTipusFirma()) {
            ...
            case Constants.TIPUS_FIRMA_EN_SERVIDOR_PLUGIN:
                if (perfil.getConfiguracioFirmaID() == null) {
                    result.rejectValue(get(CONFIGURACIOFIRMAID), "genapp.validation.required",
                            new Object[] { I18NUtils.tradueix(get(CONFIGURACIOFIRMAID)) }, null);
                }
                perfil.setApiSimpleID(null);
            break;
        ...
        switch (perfil.getTipusCustodia()) {
            case Constants.TIPUS_CUSTODIA_ARXIU:
                if (perfil.getPluginArxiuID() == null) {
                    result.rejectValue(get(PLUGINARXIUID), "genapp.validation.required",
                            new Object[] { I18NUtils.tradueix(get(PLUGINARXIUID)) }, null);
                }
            ...
            case Constants.TIPUS_CUSTODIA_DOCUMENTCUSTODY:
                if (perfil.getPluginDocCustodyID() == null) {
                    result.rejectValue(get(PLUGINDOCCUSTODYID), "genapp.validation.required",
                            new Object[] { I18NUtils.tradueix(get(PLUGINDOCCUSTODYID)) }, null);
                }
    ...
    @Override
    public void preValidate(HttpServletRequest request, PerfilForm perfilForm, BindingResult result)
            throws I18NException {
            ...
            if (tradJPA != null) {
                ...
                if (countNotNull == _trad.size()) {
                    ...
                    for (String _idioma : _trad.keySet()) {
                        es.caib.digitalib.persistence.TraduccioMapJPA _map = _trad.get(_idioma);
                        if (_map == null || (_map.getValor() == null || _map.getValor().length() == 0)) {
                            errors.rejectValue("perfil.nom", "genapp.validation.required",
                                    new String[] {
                                            org.fundaciobit.genapp.common.web.i18n.I18NUtils.tradueix(NOMID.fullName) },
                                    null);
                ...
                errors.rejectValue("perfil.nom", "genapp.validation.required",
                        new String[] { org.fundaciobit.genapp.common.web.i18n.I18NUtils.tradueix(NOMID.fullName) },
                        null);
            }
        }
        {
            ...
            if (tradJPA != null) {
                ...
                if (countNotNull == _trad.size()) {
                    ...
                    for (String _idioma : _trad.keySet()) {
                        es.caib.digitalib.persistence.TraduccioMapJPA _map = _trad.get(_idioma);
                        if (_map == null || (_map.getValor() == null || _map.getValor().length() == 0)) {
                            errors.rejectValue("perfil.descripcio", "genapp.validation.required", new String[] {
                ...
                errors.rejectValue("perfil.descripcio", "genapp.validation.required",
                        new String[] {
                                org.fundaciobit.genapp.common.web.i18n.I18NUtils.tradueix(DESCRIPCIOID.fullName) },
                        null);
            }
    ...
    @Override
    public void postList(HttpServletRequest request, ModelAndView mav, PerfilFilterForm filterForm, List<Perfil> list)
            throws I18NException {
    ...
    @Override
    public void delete(HttpServletRequest request, Perfil perfil) throws I18NException {

        perfilLogicaEjb.deletePerfilsAndRelations(perfil);
