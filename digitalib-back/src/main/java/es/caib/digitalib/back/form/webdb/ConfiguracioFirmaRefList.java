 ...
 */
@Component
public class ConfiguracioFirmaRefList extends RefListBase implements ConfiguracioFirmaFields {
    ...
    public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
        ...
        _w1 = es.caib.digitalib.model.fields.TraduccioFields.TRADUCCIOID.in(configuracioFirmaEjb.getSubQuery(_transSelect, where));
