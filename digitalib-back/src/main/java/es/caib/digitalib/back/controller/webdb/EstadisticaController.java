...
import es.caib.digitalib.back.validator.webdb.EstadisticaWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="estadistica.estadistica.plural", order=50, group=Tab.MENU_WEBDB)
@Controller
...
public class EstadisticaController
    extends es.caib.digitalib.back.controller.DigitalIBBaseController<Estadistica, java.lang.Long> implements EstadisticaFields {

  @EJB(mappedName = es.caib.digitalib.ejb.EstadisticaService.JNDI_NAME)
  protected es.caib.digitalib.ejb.EstadisticaService estadisticaEjb;
