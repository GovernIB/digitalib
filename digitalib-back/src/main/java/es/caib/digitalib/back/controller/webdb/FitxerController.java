...
import es.caib.digitalib.back.validator.webdb.FitxerWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="fitxer.fitxer.plural", order=60, group=Tab.MENU_WEBDB)
@Controller
...
public class FitxerController
    extends es.caib.digitalib.back.controller.DigitalIBBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = es.caib.digitalib.ejb.FitxerService.JNDI_NAME)
  protected es.caib.digitalib.ejb.FitxerService fitxerEjb;
