...
import es.caib.digitalib.persistence.validator.UsuariPersonaValidator;
...
public class UsuariPersonaWebValidator extends AbstractWebValidator<UsuariPersonaForm, UsuariPersona>
  ...
  @javax.ejb.EJB(mappedName = es.caib.digitalib.ejb.IdiomaService.JNDI_NAME)
  protected es.caib.digitalib.ejb.IdiomaService idiomaEjb;

  @javax.ejb.EJB(mappedName = es.caib.digitalib.ejb.UsuariPersonaService.JNDI_NAME)
