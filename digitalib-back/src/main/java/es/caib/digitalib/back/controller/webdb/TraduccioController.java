...
import es.caib.digitalib.back.form.webdb.TraduccioForm;

import es.caib.digitalib.back.validator.webdb.TraduccioWebValidator;
...
public class TraduccioController
    extends es.caib.digitalib.back.controller.DigitalIBBaseController<Traduccio, java.lang.Long> implements TraduccioFields {

  @EJB(mappedName = es.caib.digitalib.ejb.TraduccioService.JNDI_NAME)
