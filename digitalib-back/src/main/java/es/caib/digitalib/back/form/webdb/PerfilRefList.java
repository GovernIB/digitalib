 ...
 */
@Component
public class PerfilRefList extends RefListBase implements PerfilFields {
    ...
    public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
        ...
        _w1 = es.caib.digitalib.model.fields.TraduccioFields.TRADUCCIOID.in(perfilEjb.getSubQuery(_transSelect, where));
