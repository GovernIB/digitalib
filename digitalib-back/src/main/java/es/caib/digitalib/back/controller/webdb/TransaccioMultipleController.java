...
public class TransaccioMultipleController
  ...
  public String editarTransaccioMultiplePost(@ModelAttribute TransaccioMultipleForm transaccioMultipleForm,
  ...
  public String eliminarTransaccioMultiple(@PathVariable("transmultipleid") java.lang.Long transmultipleid,
    ...
    try {
      TransaccioMultiple transaccioMultiple = this.findByPrimaryKey(request, transmultipleid);
      if (transaccioMultiple == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de TransaccioMultiple
   */
  @RequestMapping(value = "/cancel")
  public String cancelTransaccioMultiple(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, TransaccioMultiple transaccioMultiple) throws I18NException {
