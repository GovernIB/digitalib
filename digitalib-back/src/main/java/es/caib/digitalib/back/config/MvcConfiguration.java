package es.caib.digitalib.back.config;
...
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new es.caib.digitalib.back.utils.DigitalIBSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new es.caib.digitalib.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new es.caib.digitalib.back.utils.DigitalIBCommonsMultipartResolver();
	}

	@Bean
	public HandlerExceptionResolver getFileSizeExceeds() {
	  return new es.caib.digitalib.back.utils.DigitalIBMaxUploadSizeExceededExceptionHandler();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/digitalib_genapp", "/WEB-INF/classes/genapp");
