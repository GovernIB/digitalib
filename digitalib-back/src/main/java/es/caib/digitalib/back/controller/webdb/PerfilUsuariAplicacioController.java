 ...
 * @author GenApp
 */
@MenuOption(labelCode="perfilUsuariAplicacio.perfilUsuariAplicacio.plural", order=120, group=Tab.MENU_WEBDB)
@Controller
...
public class PerfilUsuariAplicacioController
  ...
  public String editarPerfilUsuariAplicacioPost(@ModelAttribute PerfilUsuariAplicacioForm perfilUsuariAplicacioForm,
  ...
  public String eliminarPerfilUsuariAplicacio(@PathVariable("perfilUsrAppID") java.lang.Long perfilUsrAppID,
    ...
    try {
      PerfilUsuariAplicacio perfilUsuariAplicacio = this.findByPrimaryKey(request, perfilUsrAppID);
      if (perfilUsuariAplicacio == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de PerfilUsuariAplicacio
   */
  @RequestMapping(value = "/cancel")
  public String cancelPerfilUsuariAplicacio(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "PerfilUsuariAplicacio_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, PerfilUsuariAplicacio perfilUsuariAplicacio) throws I18NException {
