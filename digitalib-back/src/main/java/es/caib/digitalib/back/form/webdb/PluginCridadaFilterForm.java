...
public class PluginCridadaFilterForm extends DigitalIBBaseFilterForm implements PluginCridadaFields {
  ...
  private java.util.List<java.lang.Integer> tipusResultatSelect;

  public java.util.List<java.lang.Integer> getTipusResultatSelect() {
    return this.tipusResultatSelect;
  }

  public void setTipusResultatSelect(java.util.List<java.lang.Integer> tipusResultatSelect) {
    this.tipusResultatSelect = tipusResultatSelect;
  }
  ...
  public PluginCridadaFilterForm(PluginCridadaFilterForm __toClone) {
    ...
    this.tipusResultatSelect = __toClone.tipusResultatSelect;
