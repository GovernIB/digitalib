...
@Entity(name = "ConfiguracioFirmaJPA")
@Table(name = "dib_configuraciofirma" , indexes = { 
        @Index(name="dib_configuraciofirma_pk_i", columnList = "configuraciofirmaid"),
        @Index(name="dib_conffirma_plugfirma_fk_i", columnList = "pluginfirmaservidorid"),
        @Index(name="dib_conffirma_plugsegell_fk_i", columnList = "pluginsegellatid"),
        @Index(name="dib_conffirma_algofirma_fk_i", columnList = "algorismedefirmaid"),
        @Index(name="dib_conffirma_firmatper_fk_i", columnList = "firmatperformatid"),
        @Index(name="dib_conffirma_motiudele_fk_i", columnList = "motiudelegacioid")})
@SequenceGenerator(name="CONFIGURACIOFIRMA_SEQ", sequenceName="dib_configuraciofirma_seq", allocationSize=1, initialValue=1000)
@javax.xml.bind.annotation.XmlRootElement
public class ConfiguracioFirmaJPA implements ConfiguracioFirma {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="CONFIGURACIOFIRMA_SEQ")
    ...
    boolean incloureSegellDeTemps = false;
...
// IMP Field:pluginid | Table: dib_plugin | Type: 1  
    ...
    @JoinColumn(name = "pluginfirmaservidorid", referencedColumnName ="pluginID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_conffirma_plugin_fir_fk"))
...
// IMP Field:pluginid | Table: dib_plugin | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "pluginsegellatid", referencedColumnName ="pluginID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_conffirma_plugin_seg_fk"))
...
// IMP Field:traduccioid | Table: dib_traduccio | Type: 1  
    ...
    @JoinColumn(name = "firmatperformatid", referencedColumnName ="traduccioID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_conffirma_traduccio_ff_fk"))
  ...
  public java.util.Map<String, es.caib.digitalib.persistence.TraduccioMapJPA> getFirmatPerFormatTraduccions() {
    return this.firmatPerFormat.getTraduccions();
  }

  public void setFirmatPerFormatTraduccions(java.util.Map<String, es.caib.digitalib.persistence.TraduccioMapJPA> __traduccions__) {
...
// IMP Field:traduccioid | Table: dib_traduccio | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.EAGER, cascade=javax.persistence.CascadeType.ALL)
    @JoinColumn(name = "motiudelegacioid", referencedColumnName ="traduccioID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_conffirma_traduccio_md_fk"))
  ...
  @javax.xml.bind.annotation.XmlTransient
  public java.util.Map<String, es.caib.digitalib.persistence.TraduccioMapJPA> getMotiuDelegacioTraduccions() {
    return this.motiuDelegacio.getTraduccions();
  }

  public void setMotiuDelegacioTraduccions(java.util.Map<String, es.caib.digitalib.persistence.TraduccioMapJPA> __traduccions__) {
