...
@Table(name = "dib_plugincridada" , indexes = { 
        @Index(name="dib_plugincridada_pk_i", columnList = "plugincridadaid"),
        @Index(name="dib_plugcrid_pluginid_fk_i", columnList = "pluginid"),
        @Index(name="dib_plugcrid_paramfitxer_fk_i", columnList = "parametresfitxerid"),
        @Index(name="dib_plugcrid_retofitxerid_fk_i", columnList = "retornfitxerid")})
@SequenceGenerator(name="PLUGINCRIDADA_SEQ", sequenceName="dib_plugincridada_seq", allocationSize=1, initialValue=1000)
...
// IMP Field:pluginid | Table: dib_plugin | Type: 1  
    ...
    @JoinColumn(name = "pluginid", referencedColumnName ="pluginID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_plugcrid_plugin_plugini_fk"))
...
// IMP Field:fitxerid | Table: dib_fitxer | Type: 1  
    ...
    @JoinColumn(name = "parametresfitxerid", referencedColumnName ="fitxerID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_plugcrid_fitxer_paramet_fk"))
...
// IMP Field:fitxerid | Table: dib_fitxer | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "retornfitxerid", referencedColumnName ="fitxerID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_plugcrid_fitxer_retornf_fk"))
