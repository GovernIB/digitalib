...
@Entity(name = "TransaccioJPA")
@Table(name = "dib_transaccio" , indexes = { 
        @Index(name="dib_transaccio_pk_i", columnList = "transaccioid"),
        @Index(name="dib_transaccio_transmulid_fk_i", columnList = "transmultipleid"),
        @Index(name="dib_transaccio_fileplain_fk_i", columnList = "fitxerescanejatid"),
        @Index(name="dib_transaccio_filesign_fk_i", columnList = "fitxersignaturaid"),
        @Index(name="dib_transaccio_perfilid_fk_i", columnList = "perfilid"),
        @Index(name="dib_transaccio_infosignid_fk_i", columnList = "infosignaturaid"),
        @Index(name="dib_transaccio_infocustid_fk_i", columnList = "infocustodyid")})
@SequenceGenerator(name="TRANSACCIO_SEQ", sequenceName="dib_transaccio_seq", allocationSize=1, initialValue=1000)
@javax.xml.bind.annotation.XmlRootElement
public class TransaccioJPA implements Transaccio {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="TRANSACCIO_SEQ")
...
// IMP Field:transmultipleid | Table: dib_transmultiple | Type: 1  
    ...
    @JoinColumn(name = "transmultipleid", referencedColumnName ="transmultipleid", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_transaccio_transmul_tm_fk"))
...
// IMP Field:fitxerid | Table: dib_fitxer | Type: 1  
    ...
    @JoinColumn(name = "fitxerescanejatid", referencedColumnName ="fitxerID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_transaccio_fitxer_pla_fk"))
...
// IMP Field:fitxerid | Table: dib_fitxer | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "fitxersignaturaid", referencedColumnName ="fitxerID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_transaccio_fitxer_sign_fk"))
...
// IMP Field:perfilid | Table: dib_perfil | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "perfilid", referencedColumnName ="perfilID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_transaccio_perfil_perfi_fk"))
...
// IMP Field:infosignaturaid | Table: dib_infosignatura | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "infosignaturaid", referencedColumnName ="infoSignaturaID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_transaccio_infosign_fk"))
...
// IMP Field:infocustodyid | Table: dib_infocustody | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "infocustodyid", referencedColumnName ="infoCustodyID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_transaccio_infocust_fk"))
