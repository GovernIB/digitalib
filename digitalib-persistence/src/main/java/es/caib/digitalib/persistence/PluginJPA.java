...
@Table(name = "dib_plugin" , indexes = { 
        @Index(name="dib_plugin_pk_i", columnList = "pluginid")})
@SequenceGenerator(name="PLUGIN_SEQ", sequenceName="dib_plugin_seq", allocationSize=1, initialValue=1000)
