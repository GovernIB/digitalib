 ...
 * @author anadal
 */
public class PerfilUsuariAplicacioValidator<I extends PerfilUsuariAplicacio>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements PerfilUsuariAplicacioFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(PERFILID) == 0 && __vr.getFieldErrorCount(USUARIAPLICACIOID) == 0 && __vr.getFieldErrorCount(PERFILUSRAPPID) == 0) {
        java.lang.Long __perfilid = __target__.getPerfilID();
        java.lang.Long __usuariaplicacioid = __target__.getUsuariAplicacioID();
        java.lang.Long __perfilusrappid = __target__.getPerfilUsrAppID();
        Long __count_ = null;
