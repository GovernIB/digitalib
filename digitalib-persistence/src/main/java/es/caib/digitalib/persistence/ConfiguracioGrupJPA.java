...
@Entity(name = "ConfiguracioGrupJPA")
@Table(name = "dib_configuraciogrup" , indexes = { 
        @Index(name="dib_configuraciogrup_pk_i", columnList = "configuraciogrupid"),
        @Index(name="dib_cfggrup_logoheaderid_fk_i", columnList = "logoheaderid"),
        @Index(name="dib_cfggrup_logofooterid_fk_i", columnList = "logofooterid"),
        @Index(name="dib_cfggrup_perfilscan_fk_i", columnList = "perfilnomesescaneigid"),
        @Index(name="dib_cfggrup_perfilscan2_fk_i", columnList = "perfilnomesescaneig2id"),
        @Index(name="dib_cfggrup_perfilcoau_fk_i", columnList = "perfilcopiaautenticaid"),
        @Index(name="dib_cfggrup_perfilcoau2_fk_i", columnList = "perfilcopiaautentica2id"),
        @Index(name="dib_cfggrup_perfilcust_fk_i", columnList = "perfilcustodiaid"),
        @Index(name="dib_cfggrup_perfilcust2_fk_i", columnList = "perfilcustodia2id")})
@SequenceGenerator(name="CONFIGURACIOGRUP_SEQ", sequenceName="dib_configuraciogrup_seq", allocationSize=1, initialValue=1000)
@javax.xml.bind.annotation.XmlRootElement
public class ConfiguracioGrupJPA implements ConfiguracioGrup {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="CONFIGURACIOGRUP_SEQ")
...
// IMP Field:fitxerid | Table: dib_fitxer | Type: 1  
    ...
    @JoinColumn(name = "logoheaderid", referencedColumnName ="fitxerID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_fitxer_cap_fk"))
...
// IMP Field:fitxerid | Table: dib_fitxer | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "logofooterid", referencedColumnName ="fitxerID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_fitxer_peu_fk"))
...
// IMP Field:perfilid | Table: dib_perfil | Type: 1  
    ...
    @JoinColumn(name = "perfilnomesescaneigid", referencedColumnName ="perfilID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_perfil_scan_fk"))
...
// IMP Field:perfilid | Table: dib_perfil | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "perfilnomesescaneig2id", referencedColumnName ="perfilID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_perfil_scan2_fk"))
...
// IMP Field:perfilid | Table: dib_perfil | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "perfilcopiaautenticaid", referencedColumnName ="perfilID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_perfil_coau_fk"))
...
// IMP Field:perfilid | Table: dib_perfil | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "perfilcopiaautentica2id", referencedColumnName ="perfilID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_perfil_coau2_fk"))
...
// IMP Field:perfilid | Table: dib_perfil | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "perfilcustodiaid", referencedColumnName ="perfilID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_perfil_cust_fk"))
...
// IMP Field:perfilid | Table: dib_perfil | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "perfilcustodia2id", referencedColumnName ="perfilID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="dib_cfggrup_perfil_cust2_fk"))
