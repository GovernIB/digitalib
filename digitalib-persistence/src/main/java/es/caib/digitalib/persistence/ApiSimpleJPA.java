...
@Entity(name = "ApiSimpleJPA")
@Table(name = "dib_apisimple" , indexes = { 
        @Index(name="dib_apisimple_pk_i", columnList = "apisimpleid")})
@SequenceGenerator(name="APISIMPLE_SEQ", sequenceName="dib_apisimple_seq", allocationSize=1, initialValue=1000)
@javax.xml.bind.annotation.XmlRootElement
public class ApiSimpleJPA implements ApiSimple {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="APISIMPLE_SEQ")
