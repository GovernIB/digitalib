...
@Table(name = "dib_traducciomap" , indexes = { 
        @Index(name="dib_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="dib_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
