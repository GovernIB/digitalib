...
@Table(name = "dib_infosignatura" , indexes = { 
        @Index(name="dib_infosignatura_pk_i", columnList = "infosignaturaid")})
@SequenceGenerator(name="INFOSIGNATURA_SEQ", sequenceName="dib_infosignatura_seq", allocationSize=1, initialValue=1000)
