 ...
 * @author anadal
 */
public class TransaccioMultipleValidator<I extends TransaccioMultiple>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements TransaccioMultipleFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(TRANSMULTIPLEID) == 0) {
        java.lang.Long __transmultipleid = __target__.getTransmultipleid();
        Long __count_ = null;
