...
@Table(name = "dib_estadistica" , indexes = { 
        @Index(name="dib_estadistica_pk_i", columnList = "estadisticaid")})
@SequenceGenerator(name="ESTADISTICA_SEQ", sequenceName="dib_estadistica_seq", allocationSize=1, initialValue=1000)
