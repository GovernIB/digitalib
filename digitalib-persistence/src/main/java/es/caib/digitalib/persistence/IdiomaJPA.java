...
@Table(name = "dib_idioma" , indexes = { 
        @Index(name="dib_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="dib_idioma_seq", allocationSize=1, initialValue=1000)
...
// EXP  Field:idiomaid | Table: dib_usuaripersona | Type: 0  
