 ...
 */
@XmlRootElement
public class ScanWebSimpleSignedFileInfo {
  ...
  public ScanWebSimpleValidationInfo getValidationInfo() {
    return validationInfo;
  }

  public void setValidationInfo(ScanWebSimpleValidationInfo validationInfo) {
    this.validationInfo = validationInfo;
  }

  public List<ScanWebSimpleKeyValue> getAdditionInformation() {
    return additionInformation;
  }

  public void setAdditionInformation(List<ScanWebSimpleKeyValue> additionInformation) {
    this.additionInformation = additionInformation;
  }
  ...
  public static String toString(ScanWebSimpleSignedFileInfo sfi) {
    ...
    case ScanWebSimpleSignedFileInfo.SIGN_OPERATION_SIGN:
      operation = "FIRMA";
      break;
    case ScanWebSimpleSignedFileInfo.SIGN_OPERATION_COSIGN:
      operation = "COFIRMA";
      break;

    case ScanWebSimpleSignedFileInfo.SIGN_OPERATION_COUNTERSIGN:
    ...
    case ScanWebSimpleSignedFileInfo.SIGNATURESTABLELOCATION_WITHOUT:
      posicioTaulaDeFirmes = "Sense taula de Firmes";
      break;
    case ScanWebSimpleSignedFileInfo.SIGNATURESTABLELOCATION_FIRSTPAGE:
      posicioTaulaDeFirmes = "Taula de Firmes en la primera pagina";
      break;
    case ScanWebSimpleSignedFileInfo.SIGNATURESTABLELOCATION_LASTPAGE:
    ...
    ScanWebSimpleValidationInfo validationInfo = sfi.getValidationInfo();
    ...
    List<ScanWebSimpleKeyValue> additionInformation = sfi.getAdditionInformation();

    if (additionInformation != null && additionInformation.size() != 0) {
      str.append("\n").append("  + INFORMACIO ADDICIONAL:");
      for (ScanWebSimpleKeyValue firmaSimpleKeyValue : additionInformation) {
        str.append("\n").append(
