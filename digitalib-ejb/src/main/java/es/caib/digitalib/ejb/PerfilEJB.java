...
import es.caib.digitalib.persistence.PerfilJPAManager;

import es.caib.digitalib.commons.utils.Constants;

@Stateless
public class PerfilEJB extends PerfilJPAManager implements PerfilService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(Perfil instance,  FitxerService fitxerEjb)
