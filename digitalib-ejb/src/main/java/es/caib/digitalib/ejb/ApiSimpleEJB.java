...
import es.caib.digitalib.persistence.ApiSimpleJPAManager;

import es.caib.digitalib.commons.utils.Constants;

@Stateless
public class ApiSimpleEJB extends ApiSimpleJPAManager implements ApiSimpleService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(ApiSimple instance,  FitxerService fitxerEjb)
