...
public class MassiveScanWebSimpleCommonArxiuCustody {
  ...
  public MassiveScanWebSimpleCommonArxiuCustody() {
    super();
  }

  public MassiveScanWebSimpleCommonArxiuCustody(String csv, String originalFileURL,
