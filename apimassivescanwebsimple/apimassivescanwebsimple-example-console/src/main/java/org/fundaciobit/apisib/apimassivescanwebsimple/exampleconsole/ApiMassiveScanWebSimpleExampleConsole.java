...
public class ApiMassiveScanWebSimpleExampleConsole {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MassiveScanWebSimpleAvailableProfiles profiles = api
                    .getAvailableProfiles(languageUI);
            ...
            do {
                ...
                for (MassiveScanWebSimpleAvailableProfile profile : profilesList) {
                    System.out.println(i + ".-   + " + profile.getName() + "(CODI: "
                            + profile.getCode() + "): " + profile.getDescription());
            ...
            // Recuperar un ID de transacció
            {
                ...
                final String transactionName = "Transaccio Exemple "
                ...
                switch (scanWebProfileSelected.getProfileType()) {
                    ...
                    case MassiveScanWebSimpleAvailableProfile.PROFILE_TYPE_ONLY_SCAN:
                        ...
                        transacctionIdRequest = new MassiveScanWebSimpleGetTransactionIdRequest(
                                transactionName, profileCode, view, languageUI,
                                funcionariUsername);
            ...
            final String returnUrl = "http://" + host + ":" + port + "/returnurl/"
                    + transactionID;
            ...
            if (Desktop.isDesktopSupported()) {
                ...
                System.out
                        .println("Per favor obri un Navegador i copia-li la URL anterior ...");
            }
            ...
            for (String subTransactionID : subtransacions) {
                ...
                resultRequest = new MassiveScanWebSimpleSubtransactionResultRequest(
                        subTransactionID, returnScannedFile, returnSignedFile);
                ...
                switch (status) {
                    ...
                    case MassiveScanWebSimpleStatus.STATUS_FINAL_OK: // = 2;
                    {
                        ...
                        if (result.getScannedFile() != null) {
                            ...
                            System.out.println();
                            System.out.println();
                            System.out.println("Fitxer Escanejat guardat a "
                        ...
                        if (signedFile != null) {
                            File signed = new File(
                                    (count - 1) + "_signed." + signedFile.getNom());
                        ...
                        MassiveScanWebSimpleFile detachedSignedFile = result
                                .getDetachedSignatureFile();
                        ...
                        if (detachedSignedFile != null) {
                            ...
                            System.out.println(
                                    "Document Detached de la Firma (Document Escanejat) guardat a "
    ...
    public static MassiveScanWebSimpleArxiuRequiredParameters getArxiuRequiredParameters() {
        ...
        arxiuRequiredParameters = new MassiveScanWebSimpleArxiuRequiredParameters(ciutadaNif,
                ciutadaNom, documentEstatElaboracio, origen, personesInteressades,
                organsAfectats);
    ...
    public static MassiveScanWebSimpleArxiuOptionalParameters getArxiuOptionalParameters() {
        ...
        arxiuOptionalParameters = new MassiveScanWebSimpleArxiuOptionalParameters(
                procedimentNom, procedimentCodi, serieDocumental, custodyOrExpedientID);
    ...
    public static void readFromSocket(int port) throws Exception {
        ...
        System.err.println("Servidor escoltant al PORT: " + port);
        {
            ...
            System.err.println(
                    "Nou Client Connectat desde " + clientSocket.getRemoteSocketAddress());
