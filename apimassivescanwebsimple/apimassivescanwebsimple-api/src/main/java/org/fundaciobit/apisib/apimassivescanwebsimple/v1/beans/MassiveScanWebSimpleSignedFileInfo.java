...
public class MassiveScanWebSimpleSignedFileInfo {
   ...
   */
  public MassiveScanWebSimpleSignedFileInfo(Integer signOperation, String signType, String signAlgorithm,
  ...
  public static String toString(MassiveScanWebSimpleSignedFileInfo sfi) {
    ...
    str.append("\n").append("      * Mode:\t"
            + ((sfi.getSignMode() == MassiveScanWebSimpleSignedFileInfo.SIGN_MODE_IMPLICIT_ATTACHED) ? "Attached - Implicit"
                : "Detached- Explicit"));
